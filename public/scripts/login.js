    ...
    return $(`
        ...
        <div class="w3-white w3-xlarge">
            <div class="w3-bar">
                ...
                <a class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-black w3-padding-16">favorites</a>

                <a class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-black w3-padding-16">Sell</a>
                ...
                <a id="nav-user-button" href="/user/register" class="nav-item nav-link w3-hover-none w3-border-white w3-right w3-padding-16">Logged in as: ${user["user"]["email"]}</a>
            </div>
